...
var challenges = [
    // main challenges
     {options: {floorCount: 3, elevatorCount: 1, spawnRate: 0.3}, condition: requireUserCountWithinTime(Infinity, Infinity)}
    ,{options: {floorCount: 7, elevatorCount: 1, spawnRate: 0.3}, condition: requireUserCountWithinTime(Infinity, Infinity)}
    ,{options: {floorCount: 7, elevatorCount: 2, spawnRate: 0.3}, condition: requireUserCountWithinTime(Infinity, Infinity)}

    // benchmark
    ,{options: {floorCount: 3, elevatorCount: 1, spawnRate: 0.3}, condition: requireUserCountWithinTime(Infinity, 10000)}
    ,{options: {floorCount: 7, elevatorCount: 1, spawnRate: 0.3}, condition: requireUserCountWithinTime(Infinity, 10000)}
    ,{options: {floorCount: 7, elevatorCount: 2, spawnRate: 0.3}, condition: requireUserCountWithinTime(Infinity, 10000)}
    ...
    // test challenges
    ,{options: {floorCount: 3, elevatorCount: 1, spawnRate: 0.3}, condition: requireUserCountWithinTime(Infinity, 60)}
    ,{options: {floorCount: 7, elevatorCount: 1, spawnRate: 0.3}, condition: requireUserCountWithinTime(Infinity, 60)}
    ,{options: {floorCount: 5, elevatorCount: 2, spawnRate: 0.3}, condition: requireUserCountWithinTime(Infinity, 60)}
